...
const Footer = () => (
  <section className={`${styles.flexCenter} ${styles.paddingY} flex-col`}>
    ...
    {/* Logo Image, Paragraph, Links and List Items */}
    <div className={`${styles.flexStart} md:flex-row flex-col mb-8 w-full`}>
      ...
      {/* Mapping the Links Title and List Items */}
          ...
          <div key={footerLink.key} className='flex flex-col ss:my-0 my-4 min-w-[150px]'>
            ...
            <ul className='list-none mt-4'>
              {footerLink.links.map((link, index) => (
                <li key={link.name} className={`text-dimWhite font-poppins font-normal text-[16px] leading-[24px] hover:text-secondary cursor-pointer ${index !== footerLink.links.length - 1 ? 'mb-4' : 'mb-0'}`}>
                  {link.name}
                </li>
              ))}
            </ul>
    ...
    {/* Copyright text and SocialMedia Icons */}
